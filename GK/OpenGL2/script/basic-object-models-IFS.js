...
//         var s = Math.sin(u);
//         vertices[kv] = c * radius;
//         normals[kv++] = c; // Normalne s� prostopad�e do p�aszczyzny podstawy, wi�c s� r�wnoleg�e do osi X
//         vertices[kv] = s * radius;
//         normals[kv++] = s;
//         vertices[kv] = -height / 2;
//         normals[kv++] = 0; // Normalne do dna wskazuj� w d� (ujemna os Z)
...
//     normals[kv++] = 0;
//     vertices[kv] = -height / 2;
//     normals[kv++] = -1; // Normalne do dna wskazuj� w d� (ujemna os Z)
//     texCoords[kt++] = 0.5;
//     texCoords[kt++] = 0.5;
//     for (i = 0; i < slices; i++) {
//         indices[k++] = i;
...
function uvPyramid(baseWidth, height, slices, noBottom) {
    ...
    height = height || 1;
    slices = slices || 4; // zamiast slices u�ywamy jako liczby bok�w piramidy

    var vertexCount = (slices + 1) * 4;
    if (!noBottom) vertexCount += slices + 2; // dodajemy dodatkowe wierzcho�ki dla dolnej podstawy
    ...
    // Dodatkowe wierzcho�ki na wierzcho�ku piramidy
    vertices[kv] = 0;
    normals[kv++] = 0;
    vertices[kv] = 0;
    normals[kv++] = 0;
