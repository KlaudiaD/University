...
//         var s = Math.sin(u);
//         vertices[kv] = c * radius;
//         normals[kv++] = c; // Normalne s¹ prostopad³e do p³aszczyzny podstawy, wiêc s¹ równoleg³e do osi X
//         vertices[kv] = s * radius;
//         normals[kv++] = s;
//         vertices[kv] = -height / 2;
//         normals[kv++] = 0; // Normalne do dna wskazuj¹ w dó³ (ujemna os Z)
...
//     normals[kv++] = 0;
//     vertices[kv] = -height / 2;
//     normals[kv++] = -1; // Normalne do dna wskazuj¹ w dó³ (ujemna os Z)
//     texCoords[kt++] = 0.5;
//     texCoords[kt++] = 0.5;
//     for (i = 0; i < slices; i++) {
//         indices[k++] = i;
...
function uvPyramid(baseWidth, height, slices, noBottom) {
    ...
    height = height || 1;
    slices = slices || 4; // zamiast slices u¿ywamy jako liczby boków piramidy
